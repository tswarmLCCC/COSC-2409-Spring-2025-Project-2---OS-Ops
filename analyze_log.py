...
def analyze_log_file(filename="access.log"):
    ...
    **Instructions:**
    ...
    # set up variables to store data, error count, unique IPs, and URL counts
    ...
    # b.  inside this loop, first stranct the log data using the extract_log_data function or the regular expression given in the instructions.
...
def extract_log_data(line):
    ...
    **Hint:** Use capturing groups in the regular expression to extract specific parts of the matched string.
    """
